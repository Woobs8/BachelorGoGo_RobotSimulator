...
public final class RobotProtocol {
    ...
    public static String getDataBroadcastString(String carName,String battery, String memSpace, String memRemaining, String cameraAvailable, String macAddress, String ipAddress){
        ...
        // BATTERY INSERT
        data += DATA_TAGS.BATTERY_TAG + SEND_COMMANDS.SPACING_BETWEEN_TAG_AND_DATA + battery;
        data += SEND_COMMANDS.SPACING_BETWEEN_STRINGS;

        // STORAGE SPACE INSERT
        data += DATA_TAGS.STORAGE_SPACE_TAG + SEND_COMMANDS.SPACING_BETWEEN_TAG_AND_DATA + memSpace;
        data += SEND_COMMANDS.SPACING_BETWEEN_STRINGS;

        // STORAGE REMAINING INSERT
        data += DATA_TAGS.STORAGE_REMAINING_TAG + SEND_COMMANDS.SPACING_BETWEEN_TAG_AND_DATA + memRemaining;
        data += SEND_COMMANDS.SPACING_BETWEEN_STRINGS;
        ...
        // MAC ADDRESS INSERT
        data += DATA_TAGS.MAC_ADDRESS_TAG + SEND_COMMANDS.SPACING_BETWEEN_TAG_AND_DATA + macAddress;
        data += SEND_COMMANDS.SPACING_BETWEEN_STRINGS;
